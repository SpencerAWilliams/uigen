...
describe("str_replace_editor", () => {
  ...
  test("shows 'Created <file>' when complete", () => {
    render(<ToolInvocationBadge {...makeProps("str_replace_editor", { command: "create", path: "src/App.jsx" }, "result")} />);
    expect(screen.getByText("Created App.jsx")).toBeTruthy();
  });

  test("shows 'Editing <file>' for str_replace command", () => {
    render(<ToolInvocationBadge {...makeProps("str_replace_editor", { command: "str_replace", path: "components/Button.tsx" })} />);
    expect(screen.getByText("Editing Button.tsx")).toBeTruthy();
  });

  test("shows 'Edited <file>' for str_replace when complete", () => {
    render(<ToolInvocationBadge {...makeProps("str_replace_editor", { command: "str_replace", path: "components/Button.tsx" }, "result")} />);
    expect(screen.getByText("Edited Button.tsx")).toBeTruthy();
  });

  test("shows 'Editing <file>' for insert command", () => {
    render(<ToolInvocationBadge {...makeProps("str_replace_editor", { command: "insert", path: "utils/helpers.ts" })} />);
    expect(screen.getByText("Editing helpers.ts")).toBeTruthy();
  });

  test("shows 'Reading <file>' for view command", () => {
    render(<ToolInvocationBadge {...makeProps("str_replace_editor", { command: "view", path: "App.tsx" })} />);
    expect(screen.getByText("Reading App.tsx")).toBeTruthy();
  });

  test("shows 'Read <file>' for view command when complete", () => {
    render(<ToolInvocationBadge {...makeProps("str_replace_editor", { command: "view", path: "App.tsx" }, "result")} />);
    expect(screen.getByText("Read App.tsx")).toBeTruthy();
  });

  test("uses only the filename, not the full path", () => {
    render(<ToolInvocationBadge {...makeProps("str_replace_editor", { command: "create", path: "src/components/deep/Nested.tsx" })} />);
...
describe("file_manager", () => {
  test("shows 'Renaming <file>' for rename command", () => {
    render(<ToolInvocationBadge {...makeProps("file_manager", { command: "rename", path: "old.tsx", new_path: "new.tsx" })} />);
    expect(screen.getByText("Renaming old.tsx")).toBeTruthy();
  });

  test("shows 'Renamed <file>' for rename when complete", () => {
    render(<ToolInvocationBadge {...makeProps("file_manager", { command: "rename", path: "old.tsx", new_path: "new.tsx" }, "result")} />);
    expect(screen.getByText("Renamed old.tsx")).toBeTruthy();
  });

  test("shows 'Deleting <file>' for delete command", () => {
    render(<ToolInvocationBadge {...makeProps("file_manager", { command: "delete", path: "src/unused.ts" })} />);
    expect(screen.getByText("Deleting unused.ts")).toBeTruthy();
  });

  test("shows 'Deleted <file>' for delete when complete", () => {
    render(<ToolInvocationBadge {...makeProps("file_manager", { command: "delete", path: "src/unused.ts" }, "result")} />);
...
describe("unknown tool", () => {
  test("falls back to tool name for unknown tools", () => {
    render(<ToolInvocationBadge {...makeProps("some_other_tool", {})} />);
...
describe("partial-call state (args still streaming)", () => {
  test("shows in-progress label while args are streaming", () => {
    render(<ToolInvocationBadge {...makeProps("str_replace_editor", { command: "create", path: "src/App.jsx" }, "partial-call")} />);
    expect(screen.getByText("Creating App.jsx")).toBeTruthy();
  });

  test("renders spinner during partial-call", () => {
    const { container } = render(
      <ToolInvocationBadge {...makeProps("str_replace_editor", { command: "create", path: "App.jsx" }, "partial-call")} />
    );
  ...
  test("file_manager shows in-progress during partial-call", () => {
    render(<ToolInvocationBadge {...makeProps("file_manager", { command: "delete", path: "src/old.ts" }, "partial-call")} />);
...
describe("status indicator", () => {
  test("renders spinner when in progress", () => {
    const { container } = render(
      <ToolInvocationBadge {...makeProps("str_replace_editor", { command: "create", path: "App.jsx" })} />
    );
    expect(container.querySelector(".animate-spin")).toBeTruthy();
  });
  ...
  test("renders green dot when complete", () => {
    const { container } = render(
      <ToolInvocationBadge {...makeProps("str_replace_editor", { command: "create", path: "App.jsx" }, "result")} />
    );
